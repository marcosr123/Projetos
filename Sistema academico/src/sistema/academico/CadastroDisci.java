...
public class CadastroDisci extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroDisci frame = new CadastroDisci();
	...
	private class SwingAction extends AbstractAction {
		...
		public SwingAction() {
			...
			putValue(SHORT_DESCRIPTION, "Efetua cadastro da disciplina");
		}
